...
class IsDbankerUserWithAuth(permissions.BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        # if (isinstance(obj, GraphCollection) or isinstance(obj, Graph) or isinstance(obj, Modeler) or isinstance(obj, Tag) or isinstance(obj, ThresholdValue)) and not (self.action == 'retrieve' or self.action == 'list'):
        #    return False
...
class IsRegularUserWithAuth(permissions.BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        # disallow operations on Create/Delete/Edit for modelling features
        # if (isinstance(obj, Input) or isinstance(obj, AbstractInputOption) or isinstance(obj, Graph) or isinstance(obj, GraphCollection) or isinstance(obj, Node) or isinstance(obj, Weight) or isinstance(obj, Modeler) or isinstance(obj, Tag) or isinstance(obj, ThresholdValue)) and not (self.action == 'retrieve' or self.action == 'list'):
        #    return False
